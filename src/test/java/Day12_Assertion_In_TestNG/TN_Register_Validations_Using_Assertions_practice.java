...
public class TN_Register_Validations_Using_Assertions_practice {
public WebDriver driver;
	...
	@Test(priority=1)
	public void registerWithourEnteringAnyFields() {
	...
	public void registerWithMandatoryDetails() {
		...
		driver.findElement(By.cssSelector("input#input-telephone")).sendKeys("34545634566");
	...
	public void registerWithExistingEmail() {
		...
		Assert.assertEquals(actualExistingEmailWarningMessage,expectedExistingEmailWarningMessage);
