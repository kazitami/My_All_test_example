...
public class Handling_Frames_practice {
	...
	public void managingFrames() {
		...
		//Practice part
		List<WebElement> allFrames1 = driver.findElements(By.tagName("iframe"));
		System.out.println("allFrames1 - "+ allFrames1.size());
		driver.switchTo().frame(5);//going to iframe no 6. as index starts from 0
		driver.switchTo().defaultContent();//going back to previous position
