...
public class What_is_inheritance {
	...
	//Inheritance in java is a mechanism in which one Object(child) acquires all the properties and behaviors of the the Parent Object
	...
	//2. Multilevel Inheritance - GrandParent is extended by Parent which is extended by Child
