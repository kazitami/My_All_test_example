package Day14_OOps_Constructor;

//Difference no 1 - Constructor has to have the ClassName, method can have any name
//Differene no 2 - Methods have to have a return type, constructor has no return type not even void.
...
public class Constructor_Nomenclature_And_Difference_vs_Methods {
	
	public Constructor_Nomenclature_And_Difference_vs_Methods() {
