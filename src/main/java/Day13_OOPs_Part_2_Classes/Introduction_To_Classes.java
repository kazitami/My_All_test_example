package Day13_OOPs_Part_2_Classes;

public class Introduction_To_Classes {

	//Various definitions of a Class
		//1. Class is a blueprint or template which allows a developer to convey his/her logic
		//2. It reprsents set of properties that are common to all the objects of one type
		...
		public Introduction_To_Classes() {
